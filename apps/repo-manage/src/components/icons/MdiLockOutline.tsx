// Icon from Material Design Icons (MDI): https://pictogrammers.com/library/mdi/icon/lock-outline/
import * as React from "react"

type IconProps = React.SVGProps<SVGSVGElement> & { title?: string }

export const MdiLockOutline = React.forwardRef<SVGSVGElement, IconProps>(
  ({ title = "Locked", ...props }, ref) => (
    <svg
      ref={ref}
      viewBox="0 0 24 24"
      role="img"
...
MdiLockOutline.displayName = "MdiLockOutline"
