...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::roster::filter_by_pattern,
            commands::roster::preview_import_group_set,
            commands::roster::import_group_set,
            commands::roster::preview_reimport_group_set,
            commands::roster::reimport_group_set,
            commands::roster::export_group_set,
            // Validation commands
            ...
            commands::lms::sync_group_set,
            commands::lms::import_roster_from_lms,
