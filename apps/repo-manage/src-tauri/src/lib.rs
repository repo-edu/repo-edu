...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::lms::cache_lms_group_set,
            commands::lms::refresh_cached_lms_group_set,
            commands::lms::delete_cached_lms_group_set,
            commands::lms::list_cached_lms_group_sets,
            commands::lms::recache_group_set_for_assignment,
            commands::lms::detach_assignment_source,
            commands::lms::apply_cached_group_set_to_assignment,
