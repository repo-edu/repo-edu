...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::roster::import_groups_from_file,
            ...
            commands::lms::normalize_context,
            commands::lms::link_lms_group_set,
            commands::lms::copy_lms_group_set,
            commands::lms::copy_lms_group_set_to_assignment,
            commands::lms::refresh_linked_group_set,
            commands::lms::break_group_set_link,
            commands::lms::delete_group_set,
            commands::lms::list_group_sets,
            commands::lms::attach_group_set_to_assignment,
            commands::lms::clear_assignment_group_set,
