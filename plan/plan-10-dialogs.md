...
- [ ] **AddGroupDialog** (for adding groups to local/imported group sets)
...
- [ ] **ReimportGroupSetDialog** (for re-importing existing imported group sets)
  - File picker (CSV)
...
- [ ] **NewAssignmentDialog** (update existing)
  - Name input
...
- [ ] **ChangeGroupSetDialog**
  ...
  - Group set selector
  - Warning about group selection mode changes
  - Confirm button
...
- [ ] **CopyGroupSetDialog** (optional — can be inline confirmation)
...
- [ ] **DeleteGroupDialog** (new, used by GroupSetPanel)
...
- [ ] **ConfirmSharedGroupEditDialog** (new)
...
- `packages/app-core/src/components/dialogs/AddGroupDialog.tsx` (new)
...
- `packages/app-core/src/components/dialogs/NewAssignmentDialog.tsx` (update)
...
- `packages/app-core/src/components/dialogs/CopyGroupSetDialog.tsx` (new, optional)
