...
// Vendor pricing snapshot — USD per 1M tokens.
//   Anthropic input/output rate card: https://www.anthropic.com/pricing
//   Anthropic cached-read rate:       https://docs.anthropic.com/en/docs/build-with-claude/prompt-caching
//   OpenAI API price card:            https://platform.openai.com/docs/pricing
