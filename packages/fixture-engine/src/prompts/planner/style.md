...
build rounds. Reviews and refactors are inserted at orchestrator-chosen
build slots and re-examine or rework recent work regardless of style;
the style only governs the build slots themselves.
