...
export function ConnectLmsGroupSetDialog() {
  ...
  const canConnect =
    open && !!roster && !!activeProfileId && !!selectedGroupSet && !loading && !connecting;
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const updatedRoster = {
        ...roster,
        groupSets: [...roster.groupSets, { ...syncedGroupSet, id: provisionalId }],
        groups: [
          ...roster.groups,
        ...
        <DialogBody className="space-y-4">
          ...
          <FormField label="LMS Group Set" htmlFor="connect-group-set-select">
            <Select
              ...
              disabled={loading || connecting || availableGroupSets.length === 0}
            >
